...
def youdao(query: str, f: str = 'en', to: str = 'zh-CHS') -> str:
    ...
    try:
        result = json.loads(decrypt)['translateResult'][0][0]['tgt']
        print(f'有道翻译：{result}')
        time.sleep(0.5)
        return result
    except KeyError:
